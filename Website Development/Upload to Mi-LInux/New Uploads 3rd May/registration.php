...
<?php
    ...
    if (isset($_REQUEST['Username'])) {
        ...
        if (!preg_match($pattern_2, $Username)) {
            echo "The username can only contain letters, numbers, and spaces, and must be 50 characters or less.";
            exit;
        }

        if (!preg_match($pattern_2, $Name)) {
            echo "The name can only contain letters, numbers, and spaces, and must be 50 characters or less.";
            exit;
        }
        ...
        if (strlen($Email) > 50) {
            echo "The email address must be 50 characters or less.";
            exit;
        }
